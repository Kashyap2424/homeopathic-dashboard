...
// Hooks Imports
import { useAddDoctor } from "../../../hooks/admins/useAdmins";
...
const DoctorAdd = (props) => {
  ...
  const { isAddDoctorLoading, addDoctorHandler } = useAddDoctor();
  ...
  const onSubmit = async (data) => {
    const response = await addDoctorHandler(data);
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="">
                ...
                <select
                  ...
                  value={Boolean(register("is_admin").value)}
                  onChange={(e) =>
                    register("is_admin").onChange(e.target.value === "true")
                  }
                >
              ...
              <div className="">
                ...
                <select
                  ...
                  value={Boolean(register("payment_status").value)}
                  onChange={(e) =>
                    register("payment_status").onChange(
                      e.target.value === "true"
                    )
                  }
                >
            ...
            <div className="flex items-center justify-end-safe my-4">
              ...
              <div className="">
                <LoadingButton type="submit" isLoading={isAddDoctorLoading}>
                  Add Doctor
                </LoadingButton>
              </div>
            </div>
